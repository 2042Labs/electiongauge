...
plot.ioff()
plot.plot_date(romney_dates, romney_values, 'b-',label='Mitt Romney')
plot.plot_date(santorum_dates, santorum_values, 'r-', label='Rick Santorum')
plot.plot_date(gingirch_dates, gingrich_values, 'g-', label='Newt Gingrich')
plot.plot_date(paul_dates, paul_values, 'k-',label='Ron Paul')
plot.legend()
plot.savefig("../egauge/static_assets/data/hourly_averages.png")
...
plot.plot_date(paul_dates, paul_values, 'k*-', label='Ron Paul')
plot.legend()
plot.savefig("../egauge/static_assets/data/daily_averages.png")
